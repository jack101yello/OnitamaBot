...
Textbox::Textbox(int x_i, int y_i, int w_i, int h_i, unsigned char r_i, unsigned char g_i, unsigned char b_i, unsigned char tr_i, unsigned char tg_i, unsigned char tb_i, const char* message_i, TTF_Font* font_i) {
